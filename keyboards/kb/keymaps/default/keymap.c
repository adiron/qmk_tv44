...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = {
        ...
        {KC_LCTL,  KC_LALT,  KC_LGUI, KC_SPC, KC_NO, KC_NO, KC_NO,    KC_FN0,    KC_FN1, KC_RGUI, KC_NO, KC_RCTL}
    },
    [RAISE] = {
    ...
    [UTILS] = {
        ...
        {RESET, KC_TRNS,  KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO,    KC_TRNS,     KC_TRNS, KC_TRNS, KC_NO, KC_TRNS}
    },
    [MOUSE] = {
    ...
    [RAISX] = {
        {KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC,KC_AMPR,KC_ASTR,KC_LBRC,KC_RBRC,  KC_DEL},
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [1]  = ACTION_LAYER_MOMENTARY(RAISE), // RAISE
